...
/*
* * dropLastUntil
* Необходимо реализовать функцию расширения (Iterable.kt)
* для отбрасывания значений с конца списка до достижения условия
* (элемент соответствующий условию тоже должен быть исключен из результирующей коллекции) +3
...
* и возвращат список в котором исключены все элементы с конца до тех пор
* пока не будет выполнено условие предиката
